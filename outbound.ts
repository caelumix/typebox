...
interface socks<T extends string, O extends string, DS extends string>
...
interface trojan<T extends string, O extends string, DS extends string>
  extends remote<T, O, DS>, server {
  type: "trojan";
  password: string;
  tls?: tls;
...
interface naive<T extends string, O extends string, DS extends string>
  extends remote<T, O, DS>, server {
  type: "naive";
  username?: string;
  password?: string;
...
interface vless<T extends string, O extends string, DS extends string>
  extends remote<T, O, DS>, server {
  type: "vless";
  uuid: string;
...
interface tuic<T extends string, O extends string, DS extends string>
  extends remote<T, O, DS>, server {
  type: "tuic";
  uuid: string;
  password?: string;
...
interface hysteria2<T extends string, O extends string, DS extends string>
  extends remote<T, O, DS>, server {
  type: "hysteria2";
...
interface ssh<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, server, item_with_tag<T> {
  type: "ssh";
  user?: string;
  password?: string;
...
interface group_outbound<T extends string, O extends string>
  extends item_with_tag<T> {
  outbounds: O[];
  interrupt_exist_connections?: boolean;
}
interface selector<T extends string, O extends string>
  extends group_outbound<T, O> {
  type: "selector";
  default?: O;
}
interface urltest<T extends string, O extends string>
  extends group_outbound<T, O> {
  type: "urltest";
  url?: string;
  interval?: duration;
