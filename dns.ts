...
interface tcp<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "tcp";
  server: string;
  /**
...
interface udp<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "udp";
  server: string;
  /**
...
interface tls<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "tls";
  server: string;
  /**
...
interface quic<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "quic";
  server: string;
  /**
...
interface https<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "https";
  server: string;
  /**
...
interface h3<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "h3";
  server: string;
  /**
...
interface dhcp<T extends string, O extends string, DS extends string>
  extends dialer<O, DS>, item_with_tag<T> {
  type: "dhcp";
  interface?: string;
}
...
interface tailscale<T extends string, O extends string>
  extends item_with_tag<T> {
  type: "tailscale";
  /**
