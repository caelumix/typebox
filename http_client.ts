...
>(h: http_client<tag, outbound_tag, dns_server_tag>): http_client<tag, outbound_tag, dns_server_tag> => h
...
interface base_client<O extends string, DS extends string> extends dialer<O, DS> {
    /**
     * @default go
     */
    engine?: 'go' | 'apple'
